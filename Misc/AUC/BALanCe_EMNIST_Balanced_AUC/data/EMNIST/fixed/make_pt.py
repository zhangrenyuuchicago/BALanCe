...
val_dataset_size = 18800
hamming_pool_size = 18800

pool = Pool.Pool('../processed/training_balanced.pt')
test_pool = Pool.Pool('../processed/test_balanced.pt')

print('test set')
test_pool.print_class_num()
...
print('Buff val')
buff_val.print_class_num()
buff_val.balance_class()
