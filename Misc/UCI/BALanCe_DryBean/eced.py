...
def delta_eced(model, pool, hamming_pool, device, sample_num=20, hamming_dis_threshold=0.05, class_num=2):
    model.eval()
...
def delta_batch_eced(model, pool, hamming_pool, device, B=2, sample_num=20, hamming_dis_threshold=0.05, class_num=2):
    model.eval()
    dataset1 = MyDataset(pool)
    dataset2 = MyDataset(hamming_pool)
    dataloader1 = torch.utils.data.DataLoader(
...
def delta_pseudo_eced(model, pool, hamming_pool, device, B=10, sample_num=20, hamming_dis_threshold=0.05, class_num=2):
    model.eval()
    dataset1 = MyDataset(pool)
    dataset2 = MyDataset(hamming_pool)
    dataloader1 = torch.utils.data.DataLoader(
