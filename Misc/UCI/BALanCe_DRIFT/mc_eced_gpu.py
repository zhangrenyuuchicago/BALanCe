...
def delta_batch_mc_eced(model, pool, hamming_pool, device, B=10, M=10000, sample_num=20, sampling_index=4, hamming_dis_threshold=0.05, class_num=6, score_batch_size=20):
    model.eval()
